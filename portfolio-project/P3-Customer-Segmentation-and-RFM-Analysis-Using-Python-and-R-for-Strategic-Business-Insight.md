...
### 11 สร้าง Table ด้วย CREATE TABLE ทั้งหมด 5 Table
...
### 12 เพิ่มข้อมูลแต่ละเเถวเข้าไปใน TABLE ที่สร้างเมื่อสักครู่ ทั้งหมด 5 Table ด้วย INSERT INTO
...
### 13 เขียน Query ดึงข้อมูลลูกค้าที่เป็น member มีความคิดเห็นอย่างไรกับร้านอาหารของเรา
...
สิ่งที่ได้และต้อง Action คือ มีแนวโน้มที่รสชาติหรือปัจจัยเชิงลบที่ลูกค้าพบเจอได้ถูกแก้ไขไปบ้างแล้วหรือแก้ไขเสร็จแล้ว 
...
ทั้งหมดนี้ เป็นสิ่งที่เราต้อง สงสัย และต้อง Action ต่อ ซึ่งจะทำให้ธุรกิจร้านอาหารของเราเติบโต ดังนั้น

การสร้าง Database ด้วย SQL แล้วดึงคอลัมน์มาคำนวณ Basic Statistics เพื่อ Explore ดูว่าลูกค้ามีความคิดเห็นอย่างไรกับร้านอาหาร
...
1. สร้าง Database ด้วยภาษา SQL มีทั้งหมด 5 Table และสำรวจ Feedback ของลูกค้าว่ามีแนวโน้มมองธุรกิจเราว่าดีหรือไม่ดี
   ...
   เพื่อนำไป Action ต่อ เช่น ปรับปรุงรสชาติ หรือตรวจสอบความสะอาดของสถานที่, วัตถุดิบ รวมถึง Monitor ด้วยการทำ Data-Driven พัฒนาธุรกิจต่อไป
