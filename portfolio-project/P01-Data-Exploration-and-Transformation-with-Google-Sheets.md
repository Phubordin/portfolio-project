...
5. `DOB` ใช้
    ...
    - ตามด้วย `.` ที่แทนอะไรก็ได้ 1 ตัว (ผลลัพธ์คือ `14 `) และ
...
8. `Address` ใช้
    ...
    - ตามด้วย `[A-z]+` เอาตัวอักษรภาษาอังกฤษตัวใหญ่หรือตัวเล็ก เอามากี่ตัวก็ได้ อยากให้โชว์ต้องใส่วงเล็บปิดในสูตรเช่น
      อยากให้โชว์ผลลัพธ์ต้องใส่วงเล็บปิดในสูตรเช่น `(\d+ [A-z]+ )`
    - ตามด้วย `.` ตัวอะไรก็ได้ทั้งหมดเลย (ตัวอักษร, ตัวเลข, ตัวอักขระพิเศษ, white) เอามาแค่ 1 ตัว อยากให้โชว์ต้องใส่วงเล็บปิดในสูตรเช่น อยากให้โชว์ผลลัพธ์ต้องใส่วงเล็บปิดในสูตรเช่น `(\d+)`
