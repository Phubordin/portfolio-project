...
1. เราต้องการสร้างตารางเดือน months format ให้สอดคล้องกับที่มีในตารางข้อมูลของเรา โดยเราต้องเรียงลำดับของเดือนดังกล่าวไว้เพื่ออ้างอิงด้วย
...
2. `=ArrayFormula(SPLIT(A4:A9," "))`
   ...
   ซึ่งผลลัพธ์ที่ได้จะแสดงแค่ 1 แถว ดังนั้นเราจะได้ว่า
...
```
  ...
  - `=DATEDIF("2025-01-01", "2026-01-01", "M")`
     ...
     ตัวเเรกที่รับค่า คือตัวที่เราจะนำไปลบ ตัวที่สองคือตัวตั้ง `"M"` นับจำนวนเดือน

     ซึ่งผลลัพธ์ที่ได้คือ 12 (เพราะห่างกัน 12 เดือน)
    
  - `=DATEDIF("2025-01-01", "2026-01-01", "D")`
 
     ตัวเเรกที่รับค่า คือตัวที่เราจะนำไปลบ ตัวที่สองคือตัวตั้ง `"D"` นับจำนวนวัน
...
### 67 `Address` ใช้สูตร
 ...
 เราสังเกตได้ว่าทุกแถว มี `Address` อยู่ดังนั้นเราสามารถที่จะพิมพ์ลงไปใน pattern ได้เลย
