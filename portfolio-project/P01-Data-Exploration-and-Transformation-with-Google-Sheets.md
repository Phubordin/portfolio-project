...
8. `Address` ใช้
    ...
    - `\d+ ` หา pattern และดึง ค่าตัวเลข 0-9 มากี่ตัวก็ได้ (ผลลัพธ์คือ `7878`) อยากให้โชว์ผลลัพธ์ต้องใส่วงเล็บปิดในสูตรเช่น `(\d+)`
    
    - ตามด้วย white space 1 เคาะ space bar (ผลลัพธ์คือ `7878 `) อยากให้โชว์ผลลัพธ์ต้องใส่วงเล็บปิดในสูตรเช่น `(\d+ )`
    ...
    - ตามด้วย `.` ตัวอะไรก็ได้ทั้งหมดเลย (ตัวอักษร, ตัวเลข, ตัวอักขระพิเศษ, white) เอามาแค่ 1 ตัว
      (ผลลัพธ์คือ `7878 Washington United `) อยากให้โชว์ผลลัพธ์ต้องใส่วงเล็บปิดในสูตรเช่น `(\d+ [A-z]+ [A-z]+.)`
      * ถามว่าทำไมถึงไม่ใช้ white space เพราะว่าสุดท้ายมันจะหา pattern ที่อยู่ของลูกค้า `B3, B4, B6` ไม่ได้เพราะมันไม่มี pattern แล้ว ต่อให้เขียน
        pattern [A-z]+ ต่อจาก white space หรือใดๆ มันก็จะไม่เจอ pattern อยู่ดีเนื่องจาก ต่อไปจะเป็นเลขไปรษณีย์ซึ่งเป็น pattern ตัวเลข
        ดังนั้นที่ควรใช้ควรเป็น `.` ที่แทนอะไรก็ได้

    
    - ตามด้วย `.+ ` ตัวอะไรก็ได้ทั้งหมดเลย (ตัวอักษร, ตัวเลข, ตัวอักขระพิเศษ, white space) เช่นเดียวกัน แต่เอามากี่ตัวก็ได้และ เว้น white space 1 ตัว
