...
2. `Gender` ใช้
   ...
   มขออธิบายส่วน `"M[a-z]+."` โดยใช้ข้อมูลลูกค้า `B5` เป็นผลลัพธ์ตัวอย่าง
...
3. `FirstName` ใช้
   ...
   ข้อนี้จะได้ก็ต่อเมื่อทำข้อ 2 มาก่อน เพราะเราจะอ้างอิงถึงผลลัพธ์ที่อยู่ใน `D3:D7`
   ...
   - ตามด้วย `D3:D7`
     ...
     อยู่ข้างหน้าของช่วง cell `D3:D7` (ที่เราดึงมาจากข้อ 2 โดยที่ ผลลัพธ์คือ `ID 1-2222-03874-23-6 Mr.`)
...
4. `LastName` ใช้
   ...
   ข้อนี้จะทำได้ก็ต่อเมื่อทำข้อ 3 มาก่อน ซึ่งวิธีการทำจะคล้ายกับข้อ 3 เช่นเดียวกัน แค่เปลี่ยนช่วงอ้างอิงจาก `D3:D7` เป็น `E3:E7`
   กล่าวคือ จงดึงนามสกุล โดยเข้าไปหา pattern ซึ่งในที่นี้เราจะใช้ FirstName ที่ดึงมาข้อก่อนหน้ามาจับ pattern จากนั้นเราก็ใช้
   วิธีการเดิมเหมือนข้อที่ 2 ก็จะได้ นามสกุลออกมา `David`, `Anna`, `Demio`. `Lonely`, `Tayloy`
