...
8. `Address` ใช้
    ...
    - ตามด้วย `.+ ` ตัวอะไรก็ได้ทั้งหมดเลย (ตัวอักษร, ตัวเลข, ตัวอักขระพิเศษ, white space ยกเว้นการขึ้นบรรทัดใหม่ภายใน cell) แต่
     ...
     ก็จะจบสำหรับการดึงที่อยู่โดยใช้ pattern ของลูกค้าสำหรับ 5 คน
