...
1. `ID` ใช้
   ...
   ผมขออธิบายส่วน `"\d-\d{4}-\d{5}-\d{2}-\d"` โดยใช้ข้อมูลลูกค้าแถวที่ 5 เป็นผลลัพธ์ตัวอย่าง
     ...
     - `"\d-\d{4}-\d{5}-\d{2}-\d"`
       ...
       - ตามด้วย `-\d{4}` ตัวเลข 0-9 4 ตัว (ผลลัพธ์ `1-2222`)
       - ตามด้วย `-\d{5}` ตัวเลข 0-9 5 ตัว (ผลลัพธ์ `1-2222-03874`)
       - ตามด้วย `-\d{2}` ตัวเลข 0-9 2 ตัว (ผลลัพธ์ `1-2222-03874-23`)
       - หตามด้วย `-\d` ตัวเลข 0-9 1 ตัว (ผลลัพธ์ `1-2222-03874-23-6`) เป็นต้น
