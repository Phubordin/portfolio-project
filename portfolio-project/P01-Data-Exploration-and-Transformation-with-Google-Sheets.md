...
4. `DOB` ใช้
    ...
    จากนั้นมี white space ตามด้วยการจัดกลุ่ม(สังเกตการใส่วงเล็บเปิดปิด) `(\d{2}.[A-z]+.\d{4})` ซึ่งหมายถึง..

    ดึงตัวเลข 0-9 มา 2 ตัว
    
    - ตามด้วย `.` ที่แทนอะไรก็ได้ 1 ตัว และ
    - ตามด้วย `[A-z]+` ตัวอักษรภาษาอังกฤษตัวเล็กหรือตัวใหญ่กี่ตัวก็ได้
    - ตามด้วย `.` ที่จะแทนถึง white space แต่จริงมันแทนด้วยอะไรก็ได้เช่นเดียวกัน
    - ตามด้วย `\d{4}` แทนด้วยตัวเลข 0-9 4 ตัวเลข
