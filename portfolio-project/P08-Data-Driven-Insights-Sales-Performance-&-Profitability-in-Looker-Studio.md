...
📌 ปล. ที่เราต้องมาจัดการข้อมูลแบบนี้เพราะ ข้อมูลนี้มันไม่ใช่ข้อมูลจริงที่ผมบอกแต่แรกเป็นข้อมูลที่ใช่ฝึกฝนจาก tableau ดังนั้น มันอาจจะทำให้เกิดการจับคู่ที่ผิดเพี้ยนไปบ้าง
ทำให้ผมอาจจะต้องใช้วิธีที่ให้มันถูกหลักความเป็นจริงมากที่สุด แต่วิธีการจัดการกับข้อมูลเหล่านี้ ต้องไป Recheck อีกทีว่าสินค้าเรามี ID และ Name อะไรกันแน่ พร้อมกับดูราคาขายว่ามีการปรับเปลี่ยนจริงหรือเปล่า

```
(สำหรับข้อมูลชุดนี้ผมจะกำหนดไปเลยว่า 1 Product ID = 1 Product Name = 1 Price = 1 Cost = 1 Profit = 1 %NPM = 1 %ROI ทั้งหมดนี้ถ้าเชื่อมกันต้องเป็น Unique) 
